...
public class captcha1_sum extends Applet implements ActionListener
{
	...
	String input,ans="",statement,option1="Enter the sum of numbers inside Red circles",option2="Enter the sum of numbers inside Green circles",option3="Enter the sum of numbers inside Blue circles";
