...
public class captcha1 extends Applet implements ActionListener
{
	...
	String input,ans="",statement,option1="Enter the numbers from left to right inside Red circles",option2="Enter the numbers from left to right inside Green circles",option3="Enter the numbers from left to right inside Blue circles";
