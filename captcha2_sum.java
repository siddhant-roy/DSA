...
public class captcha2_sum extends Applet implements ActionListener
{
	...
	String input,ans="",statement,option1="Enter the sum of numbers inside a circle",option2="Enter the sum of numbers inside a triangle",option3="Enter the sum of numbers inside a square";
    ...
    {
        g.drawString(statement,65,125);      //Instruction for the captcha to the layout
