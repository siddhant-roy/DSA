...
public class captcha2_alpha extends Applet implements ActionListener
{
	...
	String input,ans="",statement,option1="Enter the characters from left to right inside a circle",option2="Enter the characters from left to right inside a triangle",option3="Enter the characters from left to right inside a square";
